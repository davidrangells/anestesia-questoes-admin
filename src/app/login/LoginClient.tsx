  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(1200px_circle_at_20%_0%,rgba(56,189,248,0.16),transparent_45%),radial-gradient(1000px_circle_at_100%_20%,rgba(37,99,235,0.20),transparent_42%),linear-gradient(180deg,#020817_0%,#071235_100%)] p-4 sm:p-6">
      <div className="mx-auto flex min-h-screen w-full max-w-5xl items-center justify-center">
        <div className="grid w-full overflow-hidden rounded-3xl border border-blue-200/15 bg-white/95 shadow-[0_25px_80px_rgba(2,6,23,0.45)] backdrop-blur md:grid-cols-[1.08fr_1fr] dark:border-blue-300/20 dark:bg-[#020b23]/90">
          ...
          <div className="p-5 sm:p-7 md:p-8">
            ...
            <div className="mb-6">
              <div className="text-[11px] font-bold tracking-[0.18em] text-slate-500 dark:text-slate-400">
                ACESSO ADMIN
              </div>
